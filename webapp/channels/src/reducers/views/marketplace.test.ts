...
describe('marketplace', () => {
    test('initial state', () => {
        ...
        const expectedState = {
            plugins: [], apps: [], installing: {}, errors: {}, filter: '',
        };
    ...
    test(ActionTypes.RECEIVED_MARKETPLACE_PLUGINS, () => {
        ...
        const action: GenericAction = {
            type: ActionTypes.RECEIVED_MARKETPLACE_PLUGINS, plugins: [{id: 'plugin1'}, {id: 'plugin2'}],
        };
        const expectedState = {
            plugins: [{id: 'plugin1'}, {id: 'plugin2'}], apps: [], installing: {}, errors: {}, filter: '',
        };
    ...
    describe(ActionTypes.INSTALLING_MARKETPLACE_ITEM, () => {
        ...
        it('should set installing for not already installing plugin', () => {
            const action: GenericAction = {
                type: ActionTypes.INSTALLING_MARKETPLACE_ITEM, id: 'plugin2',
            };
            const expectedState = {
                plugins: [{manifest: {id: 'plugin1'}}, {manifest: {id: 'plugin2'}}] as MarketplacePlugin[],
                apps: [],
        ...
        it('should no-op for already installing plugin', () => {
            const action: GenericAction = {
                type: ActionTypes.INSTALLING_MARKETPLACE_ITEM, id: 'plugin1',
            };
        ...
        it('should clear error for previously failed plugin', () => {
            const action: GenericAction = {
                type: ActionTypes.INSTALLING_MARKETPLACE_ITEM, id: 'plugin3',
            };
            const expectedState = {
                plugins: [{manifest: {id: 'plugin1'}}, {manifest: {id: 'plugin2'}}] as MarketplacePlugin[],
                apps: [],
    ...
    describe(ActionTypes.INSTALLING_MARKETPLACE_ITEM_SUCCEEDED, () => {
        ...
        it('should clear installing', () => {
            const action: GenericAction = {
                type: ActionTypes.INSTALLING_MARKETPLACE_ITEM_SUCCEEDED, id: 'plugin1',
            };
            const expectedState = {
                plugins: [{manifest: {id: 'plugin1'}}, {manifest: {id: 'plugin2'}}] as MarketplacePlugin[],
                apps: [],
        ...
        it('should clear error', () => {
            const action: GenericAction = {
                type: ActionTypes.INSTALLING_MARKETPLACE_ITEM_SUCCEEDED, id: 'plugin3',
            };
            const expectedState = {
                plugins: [{manifest: {id: 'plugin1'}}, {manifest: {id: 'plugin2'}}] as MarketplacePlugin[],
                apps: [],
    ...
    describe(ActionTypes.INSTALLING_MARKETPLACE_ITEM_FAILED, () => {
        ...
        it('should clear installing and set error', () => {
            const action: GenericAction = {
                type: ActionTypes.INSTALLING_MARKETPLACE_ITEM_FAILED, id: 'plugin1', error: 'Failed to intall',
            };
            const expectedState = {
                plugins: [{manifest: {id: 'plugin1'}}, {manifest: {id: 'plugin2'}}] as MarketplacePlugin[],
                apps: [],
    ...
    describe(ActionTypes.FILTER_MARKETPLACE_LISTING, () => {
        ...
        it('should set filter', () => {
            const action: GenericAction = {
                type: ActionTypes.FILTER_MARKETPLACE_LISTING, filter: 'new',
            };
            const expectedState = {
                plugins: [{manifest: {id: 'plugin1'}}, {manifest: {id: 'plugin2'}}] as MarketplacePlugin[],
                apps: [],
    ...
    describe(ActionTypes.MODAL_CLOSE, () => {
        ...
        it('should no-op for different modal', () => {
            const action: GenericAction = {
                type: ActionTypes.MODAL_CLOSE, modalId: ModalIdentifiers.DELETE_CHANNEL,
            };
            const expectedState = currentState;
        ...
        it('should clear state for marketplace modal', () => {
            const action: GenericAction = {
                type: ActionTypes.MODAL_CLOSE, modalId: ModalIdentifiers.PLUGIN_MARKETPLACE,
            };
            const expectedState = {
                plugins: [], apps: [], installing: {}, errors: {}, filter: '',
            };
